    ...
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-foreground border-b border-white/10 pb-3 text-sm font-medium text-white">This year, your savings grew more on average than you did in 2023.</div>
                <div className="space-y-3">
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium text-white">$8,081</span>
                            <span className="text-muted-foreground text-xs text-gray-400">Saved</span>
                        </div>
                    ...
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium text-white">$5,412</span>
                            <span className="text-muted-foreground text-xs text-gray-400">Saved</span>
                        </div>
                        <div className="text-foreground bg-muted flex h-5 w-2/3 items-center rounded px-2 text-xs dark:bg-white/20 bg-gray-700 text-white">2023</div>
                    </div>
                </div>
            </div>
        </div>
